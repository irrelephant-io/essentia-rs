...
impl Product {
    ...
    fn assert_valid_op(self, rhs: Product) {
        match (self, rhs) {
            ...
            (Product::Precipitate(eid1, fid1, sid1, _), Product::Precipitate(eid2, fid2, sid2, _)) => {
                if eid1 != eid2 || fid1 != fid2 || sid1 != sid2 {
                    panic!("Invalid addition! Products don't match");
                }
            }
...
impl Add<Product> for Product {
    ...
    fn add(self, rhs: Product) -> Self::Output {
        ...
        match (self, rhs) {
            ...
            (Product::Dissolve(eid1, fid1, sid1, qty1), Product::Dissolve(_, _, _, qty2)) => Product::Dissolve(
                eid1,
                fid1,
                sid1,
                qty1 + qty2
            ),
            (Product::Precipitate(eid1, fid1, sid1, qty1), Product::Precipitate(_, _, _, qty2)) => Product::Precipitate(
                eid1,
                fid1,
                sid1,
                qty1 + qty2
